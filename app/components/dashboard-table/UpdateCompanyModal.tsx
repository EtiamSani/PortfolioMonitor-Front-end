...
const UpadateCompanyModal = ({ companyId }: any) => {
  ...
  return (
    <div>
      <DialogHeader>
        <DialogTitle>Mettre à jour une entreprise</DialogTitle>
        <DialogDescription>
      ...
      <DialogFooter>
        <Button onClick={() => updateCompany(companyId, formData)}>
...
export default UpadateCompanyModal;
